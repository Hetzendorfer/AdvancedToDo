...
class Employee{
    ...
    public static function ownsToDo($employee_id, $todo_id){
        $db = new Database();
        $conn = $db->getConnection();
    ...
    public static function deleteToDo($todo_id){
        $db = new Database();
        $conn = $db->getConnection();
        $query = "DELETE FROM mitarbeiter_todo WHERE mitarbeiter_todo.id = :todo_id";
    ...
    public static function getEnterprise($employee_id){
        $db = new Database();
        $conn = $db->getConnection();
        
        $query = "SELECT unternehmen.id AS ID FROM unternehmen JOIN abteilung ON unternehmen.id = abteilung.unternehmen_id JOIN mitarbeiter ON mitarbeiter.abteilung_id = abteilung.id WHERE mitarbeiter.id = :employee_id;";
        $stmt = $conn->prepare($query);
